...
export const mockUnits: Unit[] = [
  ...
  { id: 'u3', number: '3B', type: '1BR', floor: 3, area: 38, price: 13000, status: 'occupied', tenant: 'Miguel Torres', features: ['Pool View', 'Balcony', 'Parking'] },
  ...
  { id: 'u6', number: '6B', type: '3BR', floor: 6, area: 82, price: 28000, status: 'available', features: ['Panoramic View', '2 Parking', 'Balcony', 'Study Room'] },
  { id: 'u7', number: '7B', type: '2BR', floor: 7, area: 60, price: 21000, status: 'occupied', tenant: 'Jose Reyes', features: ['City View', 'Balcony', 'Parking'] },
  { id: 'u8', number: '8C', type: '1BR', floor: 8, area: 40, price: 14500, status: 'maintenance', features: ['Pool View'] },
  { id: 'u9', number: '9D', type: '3BR', floor: 9, area: 90, price: 32000, status: 'occupied', tenant: 'Carlos Lim', features: ['Penthouse View', '2 Parking', 'Private Terrace'] },
  { id: 'u10', number: '10A', type: 'Studio', floor: 10, area: 26, price: 9500, status: 'available', features: ['City View', 'High Floor'] },
  { id: 'u11', number: '10B', type: '1BR', floor: 10, area: 38, price: 15000, status: 'available', features: ['City View', 'High Floor', 'Balcony'] },
  { id: 'u12', number: '11C', type: '2BR', floor: 11, area: 62, price: 24000, status: 'available', features: ['Panoramic View', 'Balcony', 'Parking'] },
]
...
export const mockConversations: Conversation[] = [
  {
    id: 'c1', participantId: '1', participantName: 'Maria Santos', participantUnit: '4A',
    lastMessage: 'When will the elevator be fixed?', lastTime: '10:23 AM', unread: 2,
    messages: [
  ...
  {
    id: 'c2', participantId: '2', participantName: 'Jose Reyes', participantUnit: '7B',
    lastMessage: 'Thank you for the quick response!', lastTime: '9:45 AM', unread: 0,
    messages: [
  ...
  {
    id: 'c3', participantId: '3', participantName: 'Ana Cruz', participantUnit: '2C',
    lastMessage: 'I need a visitor pass for this weekend.', lastTime: 'Yesterday', unread: 1,
    messages: [
  ...
  {
    id: 'c4', participantId: '5', participantName: 'Elena Ramos', participantUnit: '5A',
    lastMessage: 'Is the BBQ area available on the 10th?', lastTime: 'Yesterday', unread: 0,
    messages: [
  ...
  {
    id: 'c5', participantId: '6', participantName: 'Miguel Torres', participantUnit: '3B',
    lastMessage: 'Noted, thank you.', lastTime: 'Mon', unread: 0,
    messages: [
